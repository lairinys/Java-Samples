 ...
 */
public class ViewRegistrarPersona extends javax.swing.JFrame {

    /**
     * Creates new form RegistrarPaciente
     */
    public ViewRegistrarPersona() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtIdentificacion.setBounds(39, 138, 257, 40);

        jLabel1.setLabelFor(txtIdentificacion);
        jLabel1.setText("Identificación:");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(47, 116, 90, 16);
        getContentPane().add(txtNombres);
        txtNombres.setBounds(40, 210, 257, 40);

        jLabel2.setLabelFor(txtIdentificacion);
        jLabel2.setText("Nombres:");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(47, 184, 61, 16);
        getContentPane().add(txtApellidos);
        txtApellidos.setBounds(310, 210, 257, 40);

        jLabel3.setLabelFor(txtIdentificacion);
        jLabel3.setText("Apellidos:");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(320, 190, 63, 16);
        getContentPane().add(txtEdad);
        txtEdad.setBounds(40, 280, 257, 40);

        jLabel4.setLabelFor(txtIdentificacion);
        jLabel4.setText("Edad:");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(50, 260, 34, 16);

        jLabel5.setLabelFor(txtIdentificacion);
        jLabel5.setText("Género:");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(320, 260, 48, 16);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewRegistrarPersona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ViewRegistrarPersona().setVisible(true);
        });
    }
